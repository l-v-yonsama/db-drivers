...
| Name | Type |
| :------ | :------ |
| `T` | extends [`DbResource`](DbResource.md) = `AllSubDbResource` |
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`DbResource`](DbResource.md)<`AllSubDbResource`, `T`\> = `AllSubDbResource` |
...
[resource/DbResource.ts:116](https://github.com/l-v-yonsama/db-drivers/blob/20aaf5c/src/resource/DbResource.ts#L116)
