export const ResourceType = {
  ...
  CfnStack: 'CfnStack',
  // Generic, reusable container node for grouping children under a common heading in the resource tree (e.g. SSM parameters by type, Secrets Manager secrets by rotation status).
  Group: 'Group',
  // IAM-KEYCLOAK
